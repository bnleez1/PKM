...
gh-published: true
gh-published-url: "https://bnleez1.github.io/PKM/assets/pages/(pro)-pronouns"
---
...
A pronoun is a word that replaces a noun or noun phrase to avoid repetition and streamline language. *It functions as a stand-in for a person, place, thing, or idea that has been previously mentioned or is understood from context*.

# Common mistake

Incorrect: The baseball thrown by the pitcher, **it** was a strike.

Correct, The baseball thrown by the pitcher was a strike.

# Types of pronouns


💡 Personal pronouns are divided into two types: 1) subject pronouns and 2) object pronouns. **Personal pronouns** refer to the speaker, the listener, or someone or something else.
...
1. **Independent Possessive Pronouns:**
    ...
    - The red sweater is **mine**; the blue one is **yours**.

    - That pen is **his**; this one is **hers**.

    - The cat is playing with **its** toy.

    - The garden is **ours**; the flowers are **theirs**.
...
2. **Mutual Feelings or Reactions:**
    ...
    - Jane and John admire each other.

3. **Exchange of Actions or Information:**

    - They share their notes with each other.

    - The neighbors often borrow tools from each other.

4. **Reciprocal Actions with Prepositions:**

    - They sat next to each other at the concert.

    - The friends always talk about each other.

5. **Negative Sentences:**

    - They don't like each other.

    - The siblings rarely speak to each other.

6. **Emphasizing the Reciprocal Aspect:**

    - They took care of each other during their illness.

    - We promised to support each other.

7. **In Questions:**

    - Do they understand each other's feelings?

    - Have you talked to each other about the issue?

8. **Plural Nouns or Pronouns with "and":**

    - Tom and Jerry shook hands with each other.
