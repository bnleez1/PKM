...
gh-published: true
gh-published-url: "https://bnleez1.github.io/PKM/assets/pages/thesis-statement"
---
...
See also Thesis statement and skeleton outline.
...
- A problem statement/thesis statement must support a S.M.A.R.T. topic:
    ...
    - Smart
        ...
        The evidence you collect during your research project should be ***specific*** and ***narrow in scope***.

    - Measurable

        The evidence you collect for your research project should be ***measurable***; that is, ***observable***.

    - Attainable

        Your research project should be ***attainable***, ***feasible***, or ***doable***. Have you found similar studies that you can model or replicate yourself? Do you have access to participants with the profiles needed to conduct your research based on your research objectives (i.e., based on your Problem Statement)? Does your research contribute to the current body of literature that currently exists?

    - Relevant and meaningful

        Does your (i.e., Problem Statement) relate to applied linguistics in some way ***and*** is the topic meaningful to you? Does it relate to a problem that either you have faced or your learners have faced? Is it based on a "burning question" that you want to learn more about so to become a better English teacher?

    - Timely

        Does your Problem Statement motivate you to complete end-date tasks according to the timeframe requirement for completing the assignment (e.g., the syllabus, etc.)?

**Key points**

- ChatGPT test run searches

    - Search, “What are some common problems learners with learning disabilities face when trying to integrate into a mainstream classroom?

        Students with learning disabilities face several challenges when trying to integrate into a mainstream classroom. Some of the common problems include insufficient funding, inaccessible conditions, lack of individualization, troubled communication with peers, and lack of specialists¹ [^10^].

        In addition, students with learning disabilities may find it difficult to sit still or focus during a lesson. Classroom decorations, classmates, and other stimuli may be distracting for a student with a disability, making it nearly impossible to pay attention to the teacher⁸.

        Behavior problems related to the learning disability can be disruptive. In response to modifications, accommodations, and specific discipline approaches, students in the class might be resentful, believing that their peer with the learning disability has it easy⁶.

        I hope that helps. Let me know if you have any other questions.

        - Source

            Source: Conversation with Bing, 3/21/2023(1) 5 Problems Faced by Disabled Students in the Classroom. [https://www.meriahnichols.com/5-problems-faced-by-disabled-students-in-the-classroom/](https://www.meriahnichols.com/5-problems-faced-by-disabled-students-in-the-classroom/) Accessed 3/21/2023.
            (2) 5 Problems Faced by Disabled Students in the Classroom. [https://www.meriahnichols.com/5-problems-faced-by-disabled-students-in-the-classroom/](https://www.meriahnichols.com/5-problems-faced-by-disabled-students-in-the-classroom/) Accessed 3/21/2023.
            (3) Challenges and Solutions for Students with Disabilities. [https://covey.org/challenges-and-solutions-for-students-with-disabilities/](https://covey.org/challenges-and-solutions-for-students-with-disabilities/) Accessed 3/21/2023.
            (4) How Do Students with Learning Disabilities Affect the Classroom?. [https://www.healthyplace.com/parenting/learning-disabilities/how-do-students-with-learning-disabilities-affect-the-classroom](https://www.healthyplace.com/parenting/learning-disabilities/how-do-students-with-learning-disabilities-affect-the-classroom) Accessed 3/21/2023.
            (5) 5 Problems Faced by Disabled Students in the Classroom. [https://www.meriahnichols.com/5-problems-faced-by-disabled-students-in-the-classroom/](https://www.meriahnichols.com/5-problems-faced-by-disabled-students-in-the-classroom/) Accessed 3/21/2023.
            (6) Resource for Teachers of Students with Learning Disabilities - GoGuardian. [https://www.goguardian.com/blog/students-with-disabilities](https://www.goguardian.com/blog/students-with-disabilities) Accessed 3/21/2023.
            (7) What Are Classrooms Like for Students with Learning Disabilities .... [https://www.readingrockets.org/article/what-are-classrooms-students-learning-disabilities](https://www.readingrockets.org/article/what-are-classrooms-students-learning-disabilities) Accessed 3/21/2023.
            (8) Mainstreaming Special Education in the Classroom. [https://resilienteducator.com/classroom-resources/mainstreaming-special-education-in-the-classroom/](https://resilienteducator.com/classroom-resources/mainstreaming-special-education-in-the-classroom/) Accessed 3/21/2023.
            (9) What Are the Most Common Learning Problems in the Classroom Today .... [https://thriveworks.com/blog/common-learning-problems/](https://thriveworks.com/blog/common-learning-problems/) Accessed 3/21/2023.
            (10) What Are Classrooms Like for Students with Learning Disabilities .... [https://www.readingrockets.org/article/what-are-classrooms-students-learning-disabilities](https://www.readingrockets.org/article/what-are-classrooms-students-learning-disabilities) Accessed 3/21/2023.
...
- More examples of thesis statements
    ...
    - **To help many first-year university students manage their study time more effectively**, **college instructors** **should teach explicit time-management routines** **because** **they help students plan weekly priorities, they reduce last-minute cramming, and they improve follow-through on long-term assignments.**

    1. **Prepositional phrase**

    - **In response to widespread sleep deprivation among adolescents on school nights**, **school administrators** **should start the school day later** **because** **it increases students’ alertness in morning classes, it improves mood and self-regulation, and it supports better academic performance.**

    1. **Sentence connector**

    - **Therefore**, **project managers** **should require a written meeting summary after every meeting** **because** **it clarifies next steps for each person, it prevents repeated conversations, and it improves accountability for deadlines.**

    1. **Subordinating clause (not “because”)**

    - **Although many middle-school learners feel anxious about speaking in a second language**, **language teachers** **should incorporate structured pair work in every lesson** **because** **it increases low-stakes speaking practice, it builds confidence through repeated rehearsal, and it promotes negotiation of meaning with peers.**

    1. **Subordinating clause (not “because”)**

    - **Since many households waste food without realizing it**, **city governments** **should fund community composting programs** **because** **they reduce landfill waste, they create usable soil for local gardens, and they raise public awareness about sustainable consumption.**
...
Using cell phones to access online spaces, English language learners can reach outside experts to learn more about the subject matter. (Topic sentence #2)Connecting with outside experts through the use of cell phones provides...

- evidence 1

- evidence 2

English language learners receive more timely feedback by setting up social media learning spaces for one-to-one teacher-to-student engagement. (Topic sentence #3)English language teachers can assess learners throughout the learning process...
...
2. **Expository (Explanatory) Thesis Statement**
    ...
    - *Example*: Educators characterize the life of the typical college student as spending time studying, attending class, and socializing with peers.

    - Excessive screen time reduces adolescents’ sleep quality by delaying melatonin release, increasing nighttime alertness, and encouraging late-night social media habits.

    - Regular formative feedback strengthens student writing by clarifying expectations, directing revision decisions, and reinforcing transferable editing habits.

    - Peer collaboration improves second-language speaking fluency by increasing meaningful talk time, lowering affective barriers, and prompting negotiation of meaning.

    - Task-based instruction accelerates vocabulary growth by creating repeated exposure in context, requiring purposeful retrieval, and supporting deeper semantic processing.

    - Excessive screen time reduces adolescents’ sleep quality because it delays melatonin release, it increases nighttime alertness, and it encourages late-night social media habits.

    - Regular formative feedback strengthens student writing because it clarifies expectations, it guides revision decisions, and it reinforces transferable editing habits.

    - Peer collaboration improves second-language speaking fluency because it increases meaningful talk time, it lowers affective barriers, and it prompts negotiation of meaning.

    - Task-based instruction accelerates vocabulary growth because it creates repeated exposure in context, it requires purposeful retrieval, and it supports deeper semantic processing.

    - Explicit instruction in text structure improves students’ reading comprehension because it helps students predict information organization, it supports identification of main ideas, and it strengthens recall of key details.
...
- A thesis statement must support a S.M.A.R.T. topic
    ...
    - Attainable
        ...
        Your research project should be ***attainable***, ***feasible***, or ***doable***. Have you found similar studies that you can model or replicate yourself? Do you have access to participants with the profiles needed to conduct your research based on your research objectives (i.e., based on your ‣)? Does your research contribute to the current body of literature that currently exists?

    - Relevant and meaningful

        Does your (i.e., ‣) relate to applied linguistics in some way ***and*** is the topic meaningful to you? Does it relate to a problem that either you have faced or your learners have faced? Is it based on a "burning question" that you want to learn more about so to become a better English teacher?

    - Timely

        Does your ‣ motivate you to complete end-date tasks based on the syllabus calendar?
...
10. **Announcement Rather Than Thesis**:

    - "In this essay, I will talk about the causes of financial crises."
