...
[ItC 89: M.E.A.L. Plan - Developing a Body Paragraph](https://www.youtube.com/watch?v=svaqvWbndgE)[ItC 89: M.E.A.L. Plan - Developing a Body Paragraph - Notes](../Weblinks/ItC%2089%20MEAL%20Plan%20-%20Developing%20a%20Body%20Paragraph.md)

# Developing a body paragraph

[Thesis Seminar: M.E.A.L. Plan (paragraph development)](https://open.substack.com/pub/benjaminlstewart/p/thesis-seminar-meal-plan-paragraph-13d?r=jmfa&utm_campaign=post&utm_medium=web&showWelcomeOnShare=true)[Thesis Seminar: M.E.A.L. Plan (paragraph development) - Notes](../Weblinks/Thesis%20Seminar%20MEAL%20Plan%20(paragraph%20development).md)

# Paragraph Types 

When writing a thesis paper, there are three different types of paragraphs to consider: an [[Introduction Paragraph]], a body paragraph (See [[Types of body paragraphs]].), a [Transitional Paragraph](https://www.notion.so/Transitional-Paragraph-7b3606911622492db427957ead38da87?pvs=21), and a [[Conclusion paragraph]]. When writing a typical five-paragraph essay, the same types of paragraphs apply except for the transitional paragraph. An introductory paragraph, transitional paragraph, and conclusion paragraph all include a thesis statement or the main idea of the entire thesis.
...
## Linking (or summarizing) sentence
...
Since each sentence within a body paragraph serves a purpose, when the sentence is stated can be the difference between a coherent and incoherent paragraph. Here are a few examples of coherent and incoherent body paragraphs based on the order of the sentences (* indicates an incoherent body paragraph). Note that an incoherent body paragraph can also result from having a balance between evidence and analysis sentences (i.e., not having too much evidence with little analysis or vice versa).
...
Avoid using any one type of transition (e.g., sentence connectors). Instead, mix it up a bit and include @introductory phrases [Introductory Phrases](https://www.notion.so/Introductory-Phrases-1014b19081c280e5ba38c2b0c400b6af?pvs=21) and [Subordinating clauses](https://www.notion.so/Subordinating-clauses-abbf04d362e845efb6bdb5096527949f?pvs=21) to being sentences within a paragraph. *Avoid transitions to begin a paragraph, however.*

# Paragraph Length 

Think of paragraph length in terms of sentences first. Typically, body paragraphs will have five-eight well-constructed sentences with at least one of the four types of sentences: main idea, evidence, analysis, and link/summarizing sentence. If a paragraph has 225 words or more then, it might be necessary to separate it into two or more paragraphs.
...
[Paragraphing: The MEAL Plan - Notes](../PDFs/Paragraphing%20The%20MEAL%20Plan.md)

---

[Organizing Paragraphs with MEAL Plan](https://writingcenter.kennesaw.edu/resources/handouts/organizing_paragraph.php)[[Organizing Paragraphs with MEAL Plan|Organizing Paragraphs with MEAL Plan - Notes]]
