...
gh-published: true
gh-published-url: "https://bnleez1.github.io/PKM/assets/pages/(clar)-clarity-and-style"
---
...
- **Active Verbs:** Choose verbs that precisely and powerfully convey the action. A stative verb like “is” can be replaced with a more nuanced option (“suggests,” “reveals,” “establishes”). See [[Dynamic verbs]] and [Stative verbs: Expressing states, not actions](../Pages/Stative%20verbs%20Expressing%20states,%20not%20actions.md).
...
- **Coordination for** [[Parallelism]]**:** Use [[Coordinating Conjunctions (FANBOYS)]] (and, or, but, etc.) to create parallel sentence structures. This adds rhythm and emphasizes the importance of each element equally. (“The findings are **both significant and far-reaching**.”)

- **Subordination for Emphasis:** [[Subordinating Clauses]] can highlight the main idea by providing supporting details or contrasting information. The main clause becomes the focal point in relation to the dependent clause. (“**While some challenges remain**, the overall outlook is positive.”)
...
[Parallel Structure or Parallelism](https://www.youtube.com/watch?v=qvDNvS2M3QA)[[Parallel Structure or Parallelism|Parallel Structure or Parallelism - Notes]]
...
A [[(FRAG) Sentence fragment]] is a group of words that looks like a sentence, but it is not a complete sentence because it lacks a subject, a verb, or a complete thought. Sentence fragments can occur in a variety of ways, including:
...
| There is a general tendency towards…       | Generally, we see a…        |
| It is not possible to deny that…           | Undeniably…                 |
...
Remember, conciseness doesn’t mean sacrificing depth or complexity. Aim for sentences that are clear, precise, and efficient in conveying your meaning. By applying these tips and actively seeking wordy phrases, you can significantly improve the tightness and readability of your formal academic writing.

# Words and phrases to consider and avoid when writing an academic text

When writing an academic text, it’s important to consider using language that is clear, precise, and appropriate for the audience. Here are some words and phrases to consider and avoid: ## Words and Phrases to Consider

- **Precise Terminology**: Use specific and precise terminology relevant to the field of study.

- **Clear and consistent Definitions**: Clearly define any technical terms or concepts that might be unfamiliar to the reader, but for those taking [[Thesis Seminar]] or writing a five-paragraph essay, avoid drafting complete paragraphs with only definitions. Instead, define terms when necessary within the context of a topic sentence. See also [[Topic sentence-heading-thesis alignment]]. Also, be consistent when certain terms: *activities, tasks, techniques, strategies, methods, approaches*, etc.
...
- **Citations and References**: Include proper citations and references to support your arguments and give credit to original sources. (See [[(APA) APA Guide]]
    ...
    - Overgeneralizations: "people", "humans", "thing", etc. - See list of words below.
