...
- Use headings to organize your paper into sections and if necessary, sub-sections. APA style has five levels of headings, but you may not need to use all of them. *Students studying with me,* [Benjamin L Stewart](https://publish.obsidian.md/bnleez/09+PUBLISHED/Benjamin+L+Stewart)*, will never need a level 4 or level 5*. When writing a five paragraph academic essay will only require a level I. Writing a 5,000 - 6,000-word thesis paper will required two level headings and in some cases three levels. The general format for headings is:
...
- For all paragraphs prior to the References page (except when writing an abstract), include a 0.5 inch indentation by doing the following:
    ...
    [Final Formatting Tips for Microsoft Word Working Towards a Final Draft of an Academic Essay](https://www.youtube.com/watch?v=sJMvo468E30)[Final Formatting Tips for Microsoft Word Working Towards a Final Draft of an Academic Essay - Notes](../Weblinks/Final%20Formatting%20Tips%20for%20Microsoft%20Word%20Working%20Towards%20a%20Final%20Draft%20of%20an%20Aca.md)

    # Formatting, citations, and references in Word (APA)

    [APA Word formatting, citations, and references](https://www.youtube.com/watch?v=JfK4lFVOLbM)[[APA Word formatting, citations, and references|APA Word formatting, citations, and references - Notes]]

    # Setting up tables and figures in Microsoft Word

    [How to make table captions and a list of tables in word](https://www.youtube.com/watch?v=oCyxpMfuNfY)[[How to make table captions and a list of tables in word|How to make table captions and a list of tables in word - Notes]]

    # Alternative to fixing table of contents


    💡 Consider this if you are comfortable with copying and maneuvering files.

    [Thesis Seminar: Alternative fix for Table of Contents](https://www.youtube.com/watch?v=CmsRnOd7LAM)[Thesis Seminar: Alternative fix for Table of Contents - Notes](../Weblinks/Thesis%20Seminar%20Alternative%20fix%20for%20Table%20of%20Contents.md)
