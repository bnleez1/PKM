...
2. What patterns, themes, gaps, and relationships emerge across the selected sources?
...
- Organize sources through a literature map and source-management system.

- Identify themes, relationships, contradictions, gaps, methods, and limitations across sources.
...
| :-------------------- | :----------------------------------------------------------------------------------------------------- |
| **Search string**     | A planned combination of keywords and operators used to locate sources.                                |
| **Keyword**           | A term representing a central concept, population, context, or method.                                 |
| **Database**          | A structured collection of scholarly records or publications that can be searched.                     |
| **Literature map**    | A visual or structured representation of relationships among sources and ideas.                        |
| **Theme**             | A recurring concept or issue used to group evidence across sources.                                    |
| **Research gap**      | A limitation, unanswered question, underexamined context, or unresolved disagreement in existing work. |
| **Source management** | The organized storage of citations, files, notes, tags, and retrieval information.                     |
| **Verification**      | Independent confirmation that a source, claim, or relationship is accurate.                            |
| **Hallucination**     | AI-generated information that appears plausible but is false, unsupported, or fabricated.              |
| **Curation**          | Purposeful selection and organization of sources according to explicit criteria.                       |

## Main chapter content

## Searching from concepts rather than one perfect phrase
...
Verification also applies to connections among sources. AI may state that two studies conflict, but the apparent disagreement may result from different populations, definitions, methods, or outcomes. Students should compare the actual articles and record the basis of the relationship. The AI-discovery log should identify the prompt, suggested source or connection, verification method, and final decision. This process demonstrates epistemic caution and turns tool use into a critical literacy practice.

## Completing the ten-source bibliography

Each final annotation should accurately summarize the source, evaluate its quality and limitations, and explain its relevance to the literature review. The set of ten or more entries should show balance rather than repetition. Students should check whether the bibliography includes appropriate methodological and contextual diversity, whether key perspectives are missing, and whether older and recent sources are used for defensible reasons.

The final week of Unit III includes searching, mapping, source management, reference preparation, annotation drafting, fact-checking, editing, and submission. Supporting assignments include the source-evaluation matrix, literature map, and AI-discovery log. Before submission, students should conduct three audits: a source-existence audit, a citation-format audit, and an authorship audit. The authorship audit asks whether each annotation reflects the student’s reading and language. The completed bibliography becomes the fixed source base for Unit IV, so unresolved errors now will carry directly into the literature review.
